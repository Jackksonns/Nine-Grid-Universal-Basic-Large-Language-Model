...
## 更新信息
- <span style="background-color: yellow">本次启元九格开源13B多模态基础大模型，具体的模型推理等内容见：[QUICK START](https://www.osredm.com/jiuyuan/CPM-9G-8B/tree/FM9G-V/quick_start_clean/readmes/quick_start.md)</span>
